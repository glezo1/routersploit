...
class Exploit(exploits.Exploit):
    """
    Scanner implementation for all router vulnerabilities.
    """
    __info__ = {
        'name': 'Router AutoPwn',
        'description': 'Scanner module for all router vulnerabilities.',
        'authors': [
            'Daniel Gonzalez Marcos <danielgonzalezmarcos[at]hotmail.com>',  # routersploit module
        ],
        'references': (
            '',
        ),
